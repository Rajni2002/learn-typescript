...
// Generics - Let's us Parametrized types
...
// Defing a Parametrized Types -> Here to be specifically it allows to create a relation ship between `args` & `return` using Templaten
