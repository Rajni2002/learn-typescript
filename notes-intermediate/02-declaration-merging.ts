...
class Fruit2 {
  ...
  color?: string;
  static createBanana() {
    return { name: "Banana", mass: 23, color: "yellow" }
  }
}
...
// This class is also a Declartion Mereging In itself - class is both value & type

/**/
export { banana, Fruit } // -> Here we can observe that Fruit interface & function is merged together known as declaration merging